...
@Component({
    selector: 'game-character-creator',
    styleUrls: [],
    templateUrl: './game-character-creator.component.html'
})

export class GameCharacterCreatorComponent implements OnInit, AfterViewInit {
